...
class SurveySubmissionForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: SafeArea(
          child: SurveySubmissionPage(title: ''),
        ),
      ),
    );
  }
...
class SurveySubmissionPage extends StatefulWidget {
  SurveySubmissionPage({Key key, this.title}) : super(key: key);

  final String title;
  @override
  SurveySubmissionPageState createState() => SurveySubmissionPageState();
}
...
///
class SurveySubmissionPageState extends State<SurveySubmissionPage> {
